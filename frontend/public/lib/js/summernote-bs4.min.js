          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t) {
                var e = this.modules[t];
                e.shouldInitialize() &&
                  (e.events && pt.detachEvents(this.$note, e.events), e.destroy && e.destroy()),
            ...
            (n = [
                  ...
                  var e = function (t, e) {
                      ...
                      return (
                        (e
                          ...
                          : pt.prevPointUntil(pt.prevPoint(t), pt.isVisiblePoint)) || t
                      );
                    },
                        ...
                        pt.isEditable(e.node) ||
                          (o
                            ? (pt.isLeftEdgePoint(e) && s.push(e.node),
                              pt.isRightEdgePoint(e) && C.contains(s, e.node) && (i = e.node))
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    e && (n = pt.nextPointUntil(n, o)), new t(i.node, i.offset, n.node, n.offset)
                  );
                },
              },
              {
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  (e['font-size'] = parseInt(n, 10)), (e['font-size-unit'] = n.match(/[a-z%]+$/)), e
                );
              },
            },
            {
                    ...
                    if ('LI' === l.parentNode.nodeName)
                      ...
                      var u =
                          l.childNodes.length > 1
                            ? pt.splitTree(
                                l,
                                { node: s.parentNode, offset: pt.position(s) + 1 },
                ...
                if (o) {
                  ...
                  if (
                    ...
                    (s = s.concat(pt.listDescendant(n, pt.isEmptyAnchor))),
                      ...
                      (pt.isHeading(n) || pt.isPre(n) || pt.isCustomStyleTag(n)) &&
                        pt.isEmpty(n) &&
                        (n = pt.replace(n, 'p'));
                  }
                } else {
                ...
                for (
                  ...
                  switch (c.action) {
                    ...
                    case At.resultAction.SumSpanCount:
                      if (
                        'top' === e &&
                        (c.baseCell.parent ? c.baseCell.closest('tr').rowIndex : 0) <= o[0].rowIndex
                      ) {
                        var d = i()('<div></div>')
              ...
              value: function (t, e) {
                ...
                for (
                  ...
                  switch (s.action) {
                    case At.resultAction.AddCell:
                      'right' === e
                        ? i()(s.baseCell).after('<td' + l + '>' + pt.blank + '</td>')
          ...
          (n = [
              ...
              value: function (t) {
                t
                  ...
                  : ((this.lastRange = wt.create(this.editable)),
                    0 === i()(this.lastRange.sc).closest('.note-editable').length &&
                      (this.lastRange = wt.createFromBodyElement(this.editable)));
              },
            },
            {
              key: 'getLastRange',
            ...
            },
            {
              ...
              value: function () {
                var t = this.getLastRange();
                return (
                  t.isOnAnchor() && (t = wt.createFromNode(pt.ancestor(t.sc, pt.isAnchor))),
                  t.toString()
                );
              },
            },
            {
              ...
              value: function (t, e) {
                if (
                  ...
                  e &&
                    e.length &&
                    (e[0].tagName.toUpperCase() !== t.toUpperCase() && (e = e.find(t)),
                    e && e.length))
                ) {
                  var n = e[0].className || '';
                  if (n) {
              ...
              value: function () {
                ...
                (this.documentEventHandlers.onDragenter = function (o) {
                  ...
                  (this.documentEventHandlers.onDragleave = function (n) {
                    ((e = e.not(n.target)).length && 'BODY' !== n.target.nodeName) ||
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                var e = this.purify(
                    pt.value(this.$codable, this.options.prettifyHtml) || pt.emptyPara,
                  ),
                ...
                return (
                  Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) ||
                    (this.fontInstalledMap[t] =
                      m.isFontInstalled(t) || C.contains(this.options.fontNamesIgnoreCheck, t)),
                  this.fontInstalledMap[t]
                );
              },
            },
              ...
              value: function () {
                ...
                !this.isFollowing && a > l && a < c - n
                  ? ((this.isFollowing = !0),
                    ...
                    this.$toolbar.css({ position: 'fixed', top: r, width: e, zIndex: 1e3 }))
                  : this.isFollowing &&
                    (a < l || a > c) &&
                    ((this.isFollowing = !1),
                    this.$toolbar.css({
              ...
              value: function (t, e) {
                if (pt.isImg(t)) {
                  var n = i()(t).offset(),
                    ...
                    r = {};
                  this.options.popatmouse ? ((r.left = e.pageX - 20), (r.top = e.pageY)) : (r = n),
                    (r.top -= o.top),
                    (r.left -= o.left),
              ...
              value: function (t) {
                ...
                if (n && 11 === n[1].length) {
                  ...
                  e = i()('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                    ...
                    .attr(
                      'src',
                      'https://v.qq.com/txp/iframe/player.html?vid=' + w + '&amp;auto=0',
                    );
                } else if (d || h || f)
                  e = i()('<video controls>')
                    .attr('src', t)
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return e.map(function (e) {
                  ...
                  return (
                    o.append(n.template ? n.template(e) : e + ''), o.data({ index: t, item: e }), o
                  );
                });
              },
            },
              ...
              value: function (t) {
                this.$popover.is(':visible') &&
                  (t.keyCode === xt.code.ENTER
                    ...
                    : t.keyCode === xt.code.DOWN && (t.preventDefault(), this.moveDown()));
              },
            },
            {
              key: 'searchKeyword',
